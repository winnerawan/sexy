...
import com.browser.proxy.browserproxy.Browser.*;
...
import com.browser.proxy.browserproxy.utils.ProxyUtils;
...
public class NinjaWebView extends WebView implements AlbumController {
    ...
    public void setProxy(ProxyItem bDProxyItem) {
        if (bDProxyItem != null) {
...
//            this.isSystemProxySet = ProxyUtils.setProxy(this, this.currentProxyHost, this.currentProxyPort);
