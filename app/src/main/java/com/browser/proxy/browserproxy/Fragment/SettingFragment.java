package com.browser.proxy.browserproxy.Fragment;
...
import com.browser.proxy.browserproxy.Activity.ClearActivity;
import com.browser.proxy.browserproxy.Activity.TokenActivity;
import com.browser.proxy.browserproxy.Activity.WhitelistActivity;
import com.browser.proxy.browserproxy.R;
import com.browser.proxy.browserproxy.Task.*;
...
//        tabPosition.setSummary(summary);
    ...
    private void showLicenseDialog() {
        ...
        FrameLayout layout = (FrameLayout) getActivity().getLayoutInflater().inflate(R.layout.ninja_dialog_list, null, false);
